...
协方差（或相关系数）为零，即不相关，说明不存在线性关系，但可能存在非线性关系。
...
[Correlation Types • correlation](https://easystats.github.io/correlation/articles/types.html)
...
![](images/clipboard-4252541209.png)
...
```{r}
DescTools::ContCoef(eg)
```

### **Phi 系数**

![](images/clipboard-1172472303.png)
