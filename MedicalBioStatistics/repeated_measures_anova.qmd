...
连续型的重复测量资料通常采用方差分析（**Repeated-Measures Analysis of Variance**）的方法

[高级医学统计学 16.2 纵向（重复测量）资料的方差分析](https://book.sciencereading.cn/shop/book/Booksimple/onlineRead.do?id=B17792CBC7A4D446CA15AC0E4D33C445F000&bookPageNum=331)
...
![](images/单组重复测量资料的方差分析表.png){fig-align="center"}
...
![](images/多组重复测量资料的方差分析表.png){fig-align="center"}
...
## 前提假设 {style="color:red"}

-   正态性，处理因素各处理水平的个体之间相互独立，其总体均数服从正态分布

-   方差齐性，相互比较的各处理水平的总体方差相等

-   各时间点组成的协方差阵具有球形性(sphericity)特征，可采用 Mauchkly 法进行检验（**W=1）**
