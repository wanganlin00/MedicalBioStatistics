...
Pearson’s $\chi^2$ 检验 用于检验涉及**双向无序多分类变量**的概率或比例。 \### 卡方检验
...
```{r}
# SAS 中的 Fisher 精确检验示例 政党偏好
x <- matrix(c(8,4,4,9),nrow = 2,dimnames = list(c("女性","男性"),c("民主党人","共和党人")))
x
...
![](images/SASFisher_exact_test.png){fig-align="center" width="50%"}
